...
/* jcallan@github points out that declaring Multiply as a function reduces
 * code size considerably with the Keil ARM compiler. See this link for
 * more information: https://github.com/kokke/tiny-AES-C/pull/3 */
